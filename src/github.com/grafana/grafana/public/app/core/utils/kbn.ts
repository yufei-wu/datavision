  ...
  return [
    {
      ...
      submenu: [
        { text: '无', value: 'none' },
        { text: '短', value: 'short' },
        { text: '百分比 (0-100)', value: 'percent' },
        { text: '百分比 (0.0-1.0)', value: 'percentunit' },
        { text: '湿度 (%H)', value: 'humidity' },
        { text: '分贝', value: 'dB' },
        { text: '十六进制 (0x)', value: 'hex0x' },
        { text: '十六进制', value: 'hex' },
        { text: '科学计数法', value: 'sci' },
        { text: '本地格式', value: 'locale' },
      ],
    },
    {
      text: '货币',
      submenu: [
        { text: '美元 ($)', value: 'currencyUSD' },
        { text: '英镑 (£)', value: 'currencyGBP' },
        { text: '欧元 (€)', value: 'currencyEUR' },
        { text: '人民币 (¥)', value: 'currencyJPY' },
        { text: '卢布 (₽)', value: 'currencyRUB' },
        { text: '格里夫尼亚 (₴)', value: 'currencyUAH' },
        { text: '真币 (R$)', value: 'currencyBRL' },
        { text: '丹麦克朗 (kr)', value: 'currencyDKK' },
        { text: '冰岛克朗 (kr)', value: 'currencyISK' },
        { text: '挪威克朗 (kr)', value: 'currencyNOK' },
        { text: '瑞典克朗 (kr)', value: 'currencySEK' },
        { text: '捷克克朗 (czk)', value: 'currencyCZK' },
      ],
    },
    {
      text: '时间',
      submenu: [
        { text: '赫兹 (1/s)', value: 'hertz' },
        { text: '纳秒 (ns)', value: 'ns' },
        { text: '微妙 (µs)', value: 'µs' },
        { text: '毫秒 (ms)', value: 'ms' },
        { text: '秒 (s)', value: 's' },
        ...
        { text: '小时 (h)', value: 'h' },
        { text: '天 (d)', value: 'd' },
        { text: '持续时间 (ms)', value: 'dtdurationms' },
        { text: '持续时间 (s)', value: 'dtdurations' },
        { text: '持续时间 (hh:mm:ss)', value: 'dthms' },
        { text: '时间滴答 (s/100)', value: 'timeticks' },
      ],
    },
    {
      text: '日期 & 时间',
      submenu: [
        ...
        { text: '从现在开始', value: 'dateTimeFromNow' },
      ],
    },
    {
      text: '数据 (IEC)',
      submenu: [
        { text: '位', value: 'bits' },
        { text: '比特', value: 'bytes' },
        { text: 'KB', value: 'kbytes' },
        { text: 'MB', value: 'mbytes' },
        { text: 'GB', value: 'gbytes' },
      ],
    },
    {
      text: '数据 (Metric)',
      submenu: [
        { text: '位', value: 'decbits' },
        { text: '比特', value: 'decbytes' },
        { text: 'KB', value: 'deckbytes' },
        { text: 'MB', value: 'decmbytes' },
        { text: 'GB', value: 'decgbytes' },
      ],
    },
    {
      text: '数据速率',
      submenu: [
        ...
        { text: '位/秒', value: 'bps' },
        { text: '比特/秒', value: 'Bps' },
        { text: '千比特/秒', value: 'Kbits' },
        { text: 'KB/秒', value: 'KBs' },
        { text: '兆位/秒', value: 'Mbits' },
        { text: 'MB/秒', value: 'MBs' },
        { text: '千兆字节/秒', value: 'GBs' },
        { text: 'GB/秒', value: 'Gbits' },
      ],
    },
    {
      text: '散列率',
    ...
    },
    {
      text: '长度',
      submenu: [
        { text: '毫米 (mm)', value: 'lengthmm' },
        { text: '米 (m)', value: 'lengthm' },
        { text: '英尺 (ft)', value: 'lengthft' },
        { text: '公里 (km)', value: 'lengthkm' },
        { text: '英里 (mi)', value: 'lengthmi' },
      ],
    },
    {
      text: '面积',
      submenu: [
        { text: '平方米 (m²)', value: 'areaM2' },
        { text: '平方尺 (ft²)', value: 'areaF2' },
        { text: '平方英里 (mi²)', value: 'areaMI2' },
      ],
    },
    {
      text: '重量',
      submenu: [
        { text: '毫克 (mg)', value: 'massmg' },
        { text: '克 (g)', value: 'massg' },
        { text: '千克 (kg)', value: 'masskg' },
        { text: '吨 (t)', value: 'masst' },
      ],
    },
    {
      text: '速度',
    ...
    },
    {
      text: '体积',
      submenu: [
        { text: '毫升', value: 'mlitre' },
        { text: '升', value: 'litre' },
        { text: '立方米', value: 'm3' },
        { text: 'Normal cubic metre', value: 'Nm3' },
        { text: '立方分米', value: 'dm3' },
        { text: '加仑', value: 'gallons' },
      ],
    },
    {
      text: 'energy',
