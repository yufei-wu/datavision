...
* **CLI**: Make it possible to reset the admin password using the datavision-cli. [#5479](https://github.com/grafana/grafana/issues/5479)
...
* **DataVision-CLI**: Add default plugin path for MAC OS, fixes [#5806](https://github.com/grafana/grafana/issues/5806)
* **DataVision-CLI**: Improve error message for upgrade-all command, fixes [#5885](https://github.com/grafana/grafana/issues/5885)
...
* **datavision-cli**: Improve error message when failing to install plugins due to corrupt response, fixes [#4651](https://github.com/grafana/grafana/issues/4651)
...
### Bug fixes
* **datavision-cli**: Fixed issue datavision-cli tool, did not detect the right plugin dir, fixes [#4723](https://github.com/grafana/grafana/issues/4723)
...
that do not undergo transformation are just copied from public to public_gen, it is public_gen that is used by datavision-server
if it is found.
...
- binary name changed to datavision-server
- does not install to `/opt/grafana` any more, installs to `/usr/share/grafana`
- binary to `/usr/sbin/datavision-server`
- init.d script improvements, renamed to `/etc/init.d/datavision-server`
- added default file with environment variables,
  - `/etc/default/datavision-server` (deb/ubuntu)
  - `/etc/sysconfig/datavision-server` (centos/redhat)
