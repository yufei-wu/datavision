...
import (
	...
	"github.com/grafana/grafana/pkg/cmd/datavision-cli/commands"
	"github.com/grafana/grafana/pkg/cmd/datavision-cli/logger"
	"github.com/grafana/grafana/pkg/cmd/datavision-cli/services"
	"github.com/grafana/grafana/pkg/cmd/datavision-cli/utils"
)
...
func main() {
	...
	app := cli.NewApp()
	app.Name = "DataVision cli"
	app.Usage = ""
	app.Author = "DataVision Project"
